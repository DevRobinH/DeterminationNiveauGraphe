...
/**
 * Représentation de graphe orient�
 * Implémentation de la fonctionnalité permettant de déterminer
...
public class Graphe {
	...
	/**
	 * Implémentation d'un graphe en ne définissant que son nombre de sommets
	...
	public ArrayList<Sommet> initListeSommet (int matrice[][]) {
		...
		for (int i = 0; i < matrice.length; i++) {
			...
			// parcours des colonnes afin de déterminer les prédécesseurs
	...
	/**
	 * Détermination des différents niveaux d'un graphe orient�e
	 */
